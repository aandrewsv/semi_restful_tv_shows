...
SECRET_KEY = '(ov2(&q(7h4%*ws9&u9nf!l9ree35ha%$m77j!(#9ut2i+dn9+'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'semi_restful_tv_shows_db', # nombre de la base de datos, se creará en el servidor de Postgres a continuación
